...
object ClusterShardingExample {
  ...
  // create an Pekko Cluster Sharding `EntityTypeKey` for `User` for this Kafka Consumer Group
  ...
  // #rebalance-listener
  // obtain an Pekko classic ActorRef that will handle consumer group rebalance events
